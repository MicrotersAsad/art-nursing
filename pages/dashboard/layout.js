...
//       {/* Sidebar */}
//       <div
//         className={`fixed inset-y-0 left-0 z-40 transform transition-all duration-300 bg-[#282a42] text-white shadow-lg ${
...
const Layout = React.memo(({ children }) => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-100">
      ...
      {/* Sidebar */}
      <div
  className={`fixed inset-y-0 left-0 z-40 transform transition-all duration-300 bg-[#282a42] text-white shadow-lg ${isCollapsed ? 'w-20' : 'w-64'} ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:static lg:inset-0 overflow-auto h-screen`} /* Added 'overflow-auto' and 'h-screen' */
